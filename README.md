# Mailgun Plugin for CakePHP 3.7 and 4.0
...
**If you are looking for CakePHP 3.7+ version of this plugin please see the [4.x](https://github.com/narendravaghela/cakephp-mailgun/tree/4.x) branch.** 
